...
class Test_Login:
    ...
    def test_login(self, setup):
        ...
        human_title_locator = self.driver.find_element(By.XPATH, recaptcha_page.LBL_HUMAN_TITLE)
        ...
        self.recaptcha = recaptcha_page(self.driver)

        if human_title_locator.is_displayed():
            print("Human title found.")
        else:
            print("Human title not found.")
